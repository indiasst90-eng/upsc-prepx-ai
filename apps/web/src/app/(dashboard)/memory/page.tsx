...
// Dynamic import of the 3D content to avoid SSR issues
const MemoryPalace3D = dynamic(() => import('./MemoryPalace3D'), {
  ssr: false,
  loading: () => (
    <div className="w-full h-screen bg-gradient-to-b from-slate-900 to-purple-950 flex items-center justify-center">
      <div className="text-white text-xl">Loading 3D Memory Palace...</div>
    </div>
  ),
});
...
export default function MemoryPalacePage() {
  ...
  if (!mounted) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-slate-900 to-purple-950 flex items-center justify-center">
        <div className="text-white text-xl">Loading Memory Palace...</div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* 3D Canvas */}
      <MemoryPalace3D rooms={rooms} onNodeClick={setSelectedNode} />
